...
class BitcoinTestFramework(object):
    ...
    def enable_mocktime(self):
        ...
        2014 + (201 * 10 * 60)"""
        self.mocktime = 1503596800 + (201 * 10 * 60)
    ...
    def _initialize_chain(self):
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                ...
                args = [os.getenv("BITCOIND", "bitcoin2xd"), "-server", "-keypool=1", "-datadir=" + datadir, "-discover=0"]
                if i > 0:
...
class ComparisonTestFramework(BitcoinTestFramework):
    ...
    def add_options(self, parser):
        parser.add_option("--testbinary", dest="testbinary",
                          default=os.getenv("BITCOIND", "bitcoin2xd"),
                          help="bitcoin2xd binary to test")
        parser.add_option("--refbinary", dest="refbinary",
                          default=os.getenv("BITCOIND", "bitcoin2xd"),
                          help="bitcoin2xd binary to use for reference nodes (if any)")
